...
export function CreateNote({ onNoteCreated }: CreateNoteProps = {}) {
  ...
  if (barDuration !== DEFAULT_BAR_SECONDS) {
    const barLabel =
            ...
            {(voiceEnabled || imageEnabled || videoEnabled) && (
              <div className={styles.modeToggle} role='tablist' aria-label='note type'>
                <button
                  ...
                  className={`${styles.modeToggleBtn} ${mode === 'text' ? styles.modeToggleActive : ''}`}
                ...
                {voiceEnabled && (
                  <button
                    ...
                    className={`${styles.modeToggleBtn} ${mode === 'voice' ? styles.modeToggleActive : ''}`}
                ...
                {imageEnabled && (
                  <button
                    ...
                    className={`${styles.modeToggleBtn} ${mode === 'image' ? styles.modeToggleActive : ''}`}
            ...
            <div className={styles.expertPanel}>
              ...
              <div className={styles.expertSection}>
                ...
                <div className={styles.expertSectionRow}>
                  {!isMediaMode && (<div className={styles.advancedRowWrap}>
                  ...
                  <div className={styles.advancedRowWrap}>
                    <div className={styles.advancedRow}>
                      ...
                      <OnOffToggle
                        ...
                        onToggle={() => {
                          if (!timeLockEnabled && !timeLockAt) {
                            setTimeLockAt(
                              new Date(Date.now() + DEFAULT_TIMELOCK_OFFSET_MS)
                                .toISOString()
                                .slice(0, 16),
                            );
                          }
                    ...
                    {timeLockEnabled && (
                      <input
                        ...
                        min={new Date(Date.now() + MIN_TIMELOCK_OFFSET_MS)
                          .toISOString()
                          .slice(0, 16)}
              ...
              {!isMediaMode && <div className={styles.expertDivider} />}

              {/* — plausible deniability — */}
              {!isMediaMode && (<div className={styles.expertSection}>
                  ...
                  <span className={styles.sentenceControl}>
                    <span className={styles.passwordInputWrapper}>
                      <input
                        ...
                        style={{
                          width: `${Math.max(MIN_PASSWORD_INPUT_WIDTH, password.length + 1)}ch`,
                        }}
                        value={password}
                        onChange={(e) =>
                          setPassword(
